...
public class MongoConfig2 {
    ...
    private final String USER = "MONGOUSER2";
    private final String PASSWORD = "MONGOPASSWORD456";
    private final String SERVER = "MONGODB.CLOUD.SERVER2";
    ...
    public String getMongoClientUri() {
        try {
            ...
            String mongoClientUri = "mongodb+srv://" + USER + ":" + PASSWORD + "@" + SERVER + "/sampledb";

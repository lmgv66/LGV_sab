...
public class MongoConfig3 {
    ...
    private final String USER = "ADMINUSER";
    private final String PASSWORD = "ADMINPASSWORD789";
    private final String SERVER = "MONGODB.CLOUD.SERVER3";
    ...
    public String getMongoClientUri() {
        try {
            ...
            String mongoClientUri = "mongodb+srv://" + USER + ":" + PASSWORD + "@" + SERVER + "/admin";
